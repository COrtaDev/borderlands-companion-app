  ...
  return (
    ...
    <>
      <ButtonGroup vertical>
        ...
        <Button variant={shieldButtonVariant} onClick={handleShieldSelect}>
          Shield
        </Button>
        <Button variant={grenadeButtonVariant} onClick={handleGrenadeSelect}>
          Grenade Mod
        </Button>
        <Button variant={artifactButtonVariant} onClick={handleArtifactSelect}>
          Artifact
        </Button>
        <DropdownButton
          as={ButtonGroup}
          variant={classButtonVariant}
          title={classModType}
          id="bg-nested-dropdown"
