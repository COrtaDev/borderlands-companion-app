...
import SelectManufacturer from '../sub-components/SelectManufacturer';

const SelectManufacturerModal = (props) => {
        ...
        <>
            <Modal {...props} size='sm' aria-labelledby='contained-modal-title-vcenter' centered>
                ...
                <Modal.Body style={{ display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
                    <p>Select Item Manufacturer</p>
                    <p>Choose Manufacturer:</p>
                    <SelectManufacturer {...props} />
                </Modal.Body>
            </Modal>
        </>
    );
}
export default SelectManufacturerModal;
